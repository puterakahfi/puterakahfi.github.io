    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      ...
      <div>
        <a
          ...
          class="inline-block text-sm px-2 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0"
        > <i class="fab fa-facebook fa-2x fill-current  " ></i></a>
            <a
        ...
        > <i class="fab fa-github fa-2x fill-current  " ></i></a>
