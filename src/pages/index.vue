      ...
      <div class="colum is-3 has-padding-5">
        <div data-aos="fade-up">
          <g-image
            ...
            alt
          ></g-image>
          <h1 class="title is-4 has-text-left has-margin-bottom-5">Free Learning Resources</h1>
          <p
            class="has-margin-top-5 is-size-7"
          >Koleski berbagai link, tutorial, free e-books terkait pemrograman, software development</p>
          <a
        ...
        <div data-aos="fade-up">
          ...
          ></g-image>
          <h1
            class="title is-4 has-text-left has-margin-bottom-5"
          >Awesome Javascript Developer Indonesia</h1>
          <p
            class="has-margin-top-5 is-size-7"
          >Daftar developer/programmer javascript terkece asal Indonesia</p>
          <a
